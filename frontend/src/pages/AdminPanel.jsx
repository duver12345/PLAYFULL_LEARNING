...
import { Users, School, Gift, LogOut, Menu } from "lucide-react";
    ...
    <div className="flex min-h-screen bg-slate-50 text-slate-800">
      ...
      >
        <div className="h-full bg-gradient-to-b from-purple-600 via-indigo-600 to-sky-600 text-white shadow-lg p-6 flex flex-col">
          ...
          <div className="mt-4">
            <button className="w-full flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-red-600/90 transition">
              <LogOut size={18} />
              Cerrar sesión
            </button>
          </div>
